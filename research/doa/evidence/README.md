...
They were generated with the fixed seeds and `preview` RIR quality documented
by each experiment. Large RIR caches, observations, spectra, and NPZ files are
excluded from Git and can be regenerated with the commands below.
